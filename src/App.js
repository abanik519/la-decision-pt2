            ...
            <div className="slide-container">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                          <div className="flex-row">
                            <img alt='' className="avatar" src={avatar} alt="Owl avatar" onClick={() => {this.toggle('s1'); this.hide('click2'); this.showNext()}}/>
                          ...
                          <div id="s1" className="speech2" alt="A group of children">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s2" className="speech2" alt="A group of colorful food items">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s3" className="speech2" alt="A group of robbers">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s4" className="speech2" alt="No water tap">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s5" className="speech2" alt="A group of people sitting around a table with computers">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s6" className="speech2" alt="People gathering together">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s7" className="speech2" alt="Children trying to resolve a problem">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s8" className="speech2" alt="Boy and girl gardening">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s9" className="speech2" alt="person digging a hole">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s10" className="speech2" alt="People screaming together">
